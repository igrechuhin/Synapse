...
- **Skills**: if findings concern tool/workflow patterns → update or create `.cortex/resources/skills/` entry.
...
- **Rules**: if findings concern recurring standards violations → create/update `.cortex/synapse/rules/` entry.
